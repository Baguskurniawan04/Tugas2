    ...
    <body>
        <div class="container mt-4 ml-7 mr-7">
            ...
            <div class="row text-center">
              <div class="col-sm"><strong>Nama:</strong> bagus kurniawan adhi hadiartha</div>
              <div class="col-sm"><strong>Nim:</strong> 17.01.53.0018</div>
            </div>
        ...
        <script>
            function get_data(){
                $.ajax({
                    url: 'https://snapku.000webhostapp.com/webservice/Tambah.php',
                    method: "POST",
                    data: {show: 2},
                    dataType: "JSON",
